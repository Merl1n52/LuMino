...
<main id="primary" class="site-main">
    ...
    <section class="lumino-project-content" style="padding-top: 40px;">
        <div class="lumino-container">
            ...
            <!-- Showcase Gallery (Supports long visual scrolls like BRUTAR.png) -->
            <div class="lumino-project-gallery">
                <?php if (has_post_thumbnail()) : ?>
                    <div class="lumino-gallery-item" style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; overflow: hidden; margin-bottom: 40px;">
                        <?php the_post_thumbnail('lumino-full-showcase', array('loading' => 'eager', 'style' => 'width: 100%; height: auto;')); ?>
                    </div>
                <?php endif; ?>

                <div class="lumino-gallery-item" style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; overflow: hidden;">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/BRUTAR.png'); ?>" alt="<?php the_title_attribute(); ?> Presentation" loading="lazy" style="width: 100%; height: auto;">
                </div>
            </div>
