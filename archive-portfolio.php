        ...
        <div class="lumino-container">
            <div class="lumino-dark-grid-3">
                ...
                if (have_posts()) :
                    ...
                    $demo = array(
                        array('title' => 'FF 2024', 'year' => '2024', 'service' => 'Product Design', 'img' => get_template_directory_uri() . '/assets/images/fava.png'),
                        array('title' => '1988 Project', 'year' => '2023', 'service' => 'Branding', 'img' => get_template_directory_uri() . '/assets/images/BRUT.png'),
                        array('title' => 'Geschieden', 'year' => '2021', 'service' => 'Editorial', 'img' => get_template_directory_uri() . '/assets/images/MIRA1.png'),
                        array('title' => 'SORA Vision', 'year' => '2022', 'service' => 'Interface', 'img' => get_template_directory_uri() . '/assets/images/sora1.png'),
                    );
                    foreach ($demo as $d) :
                        ?>
