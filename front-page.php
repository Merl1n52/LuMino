...
<main id="primary" class="site-main">
                ...
                if ($portfolio_query->have_posts()) :
                    ...
                    $default_projects = array(
                        ...
                        array(
                            ...
                            'year'     => '2023',
                            'service'  => 'Branding',
                            'img'      => get_template_directory_uri() . '/assets/images/BRUT.png',
                        ),
                        array(
                            'title'    => 'Geschieden',
                            'year'     => '2021',
                            'service'  => 'Editorial',
                            'img'      => get_template_directory_uri() . '/assets/images/MIRA1.png',
                        ),
                    );
    ...
    <!-- ARCHIVE WORK SECTION (ASYMMETRIC MASONRY GRID) -->
    <section id="archive" class="lumino-dark-archive">
        <div class="lumino-container">
            <div class="lumino-archive-wrapper">
                <div class="lumino-section-heading-block">
                    <h2 class="lumino-section-huge-title"><?php esc_html_e('Archive', 'lumino'); ?><br><?php esc_html_e('Work', 'lumino'); ?></h2>
                    <div>
                        <span class="lumino-badge-red"><?php esc_html_e('Past Work', 'lumino'); ?></span>
                    </div>
                    <p style="font-size: 13px; color: var(--text-secondary); line-height: 1.6; margin-top: 16px;">
                        <?php esc_html_e("Series of past experiments and other stuff i've done along the years", 'lumino'); ?>
                    </p>
                </div>

                <div class="lumino-archive-masonry">
                    <!-- Column 1 -->
                    <div class="lumino-archive-column">
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_tryit.jpg'); ?>" alt="Try It" loading="lazy">
                        </div>
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_circle.png'); ?>" alt="Circle Art" loading="lazy">
                        </div>
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_face_noise.jpg'); ?>" alt="Noise Portrait" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="lumino-archive-column">
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_device.jpg'); ?>" alt="Hardware Device" loading="lazy">
                        </div>
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_tablet.jpg'); ?>" alt="Tablet Interface" loading="lazy">
                        </div>
                        <div class="lumino-archive-tile">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/donor/archive_bossanova.jpg'); ?>" alt="Bossa Nova" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
